...
def setup_Fragmenstein(template_path: str) -> Laboratory:
    ...
    os.mkdir('check_base_placements_april7/iris_placements/output')
    os.chdir('check_base_placements_april7/iris_placements/output')
...
def main():
    # Load df
    csv_path = os.path.join(os.getcwd(), 'base_compounds/syndirella_input_MASTER_FINAL_exact.csv')
    ...
    # Load fragments
    hits_path = os.path.join(os.getcwd(), 'fragments/TO_USE/A71EV2A_combined.sdf')
    # Load template
    template_path = os.path.join(os.getcwd(), 'fragments/TO_USE/Ax0310_relaxed_apo.pdb')
    # Initiate laboratory
    ...
    placements.to_csv('iris_placements.csv')
