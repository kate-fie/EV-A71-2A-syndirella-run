...
pwd;
export INPUT="/data/xchem-fragalysis/kfieseler/EV-A71-2A-syndirella-run/batches/batch4.csv"
export OUTPUT_DIR="/data/xchem-fragalysis/kfieseler/A71EV2A_run2/batch4";
