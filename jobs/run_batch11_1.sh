...
pwd;
export INPUT="/data/xchem-fragalysis/kfieseler/EV-A71-2A-syndirella-run/batches/batch11_1.csv"
export OUTPUT_DIR="/data/xchem-fragalysis/kfieseler/A71EV2A_run2/batch11";
export TEMPLATE="/data/xchem-fragalysis/kfieseler/EV-A71-2A-syndirella-run/fragments/x0310_relaxed_apo.pdb";
export HITS="/data/xchem-fragalysis/kfieseler/EV-A71-2A-syndirella-run/fragments/new_hits.sdf";
