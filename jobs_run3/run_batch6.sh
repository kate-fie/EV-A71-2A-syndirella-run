...
pwd;
export INPUT="/data/xchem-fragalysis/kfieseler/EV-A71-2A-syndirella-run/batches_run3/batch6.csv"
export OUTPUT_DIR="/data/xchem-fragalysis/kfieseler/A71EV2A_run3/batch6";
